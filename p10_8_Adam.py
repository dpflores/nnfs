# Using Adaptative momentum (combines the cache and momentum )
# Adam optimizer is usually the best optimizer, but not allways. It is a 
# good idea to try Adam first, and the the others optimizers if it is not working as you expected

# For SGD, a generla learning rate is 1.0 with decay down to 0.1. For Adam, a good lr is 0.001
# with decay of 0.0001
