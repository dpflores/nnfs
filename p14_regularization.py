# Lets perform L1 and L2 regularization to reduce generalization error
...
# The implementation of regularizer, improves the performance even if we increment the amount of neurons of layers.
# This because regularization allows us to create much larger models without fear of overfitting (or memorization).